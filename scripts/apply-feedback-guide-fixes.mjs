...
const teamStrip = (members) => `<div class="seo-team-strip">${members.map(([slug, role, name = slug]) => `<span><img src="../../assets/characters/${slug}.webp" alt="" loading="lazy" decoding="async"><small>${role}</small><strong>${name}</strong><em>Open guide for details</em></span>`).join("")}</div>`;
...
const specificGuides = {
  rebecca: {
    ...
    panels: `<div class="seo-team-panels"><div class="seo-team-panel"><header><strong>Lucy Hack-Shifting team</strong><span>Recommended</span></header>${teamStrip([["lucy", "Main DPS", "Lucy"], ["rebecca", "Sub DPS", "Rebecca"], ["mornye", "Support", "Mornye"]])}<p class="seo-team-note">Rebecca is Lucy's intended Hack-Shifting partner. Mornye supplies the real sustain slot.</p></div><div class="seo-team-panel"><header><strong>Lucy comfort alternative</strong><span>Alternative</span></header>${teamStrip([["lucy", "Main DPS", "Lucy"], ["rebecca", "Sub DPS", "Rebecca"], ["shorekeeper", "Support", "Shorekeeper"]])}<p class="seo-team-note">Keep the Lucy and Rebecca core, then use an owned healer when Mornye is unavailable. Verina can fill the same support slot.</p></div><div class="seo-team-panel"><header><strong>Heavy Attack support route</strong><span>Alternative</span></header>${teamStrip([["yangyang-xuanling", "Main DPS", "Yangyang: Xuanling"], ["rebecca", "Sub DPS", "Rebecca"], ["chisa", "Support", "Chisa"]])}<p class="seo-team-note">Rebecca supports the Heavy Attack direction while Chisa covers utility and limited recovery.</p></div></div>`,
  ...
  cartethyia: {
    ...
    panels: `<div class="seo-team-panels"><div class="seo-team-panel"><header><strong>Best team</strong><span>Recommended</span></header>${teamStrip([["cartethyia", "Main DPS", "Cartethyia"], ["ciaccona", "Sub DPS", "Ciaccona"], ["chisa", "Support", "Chisa"]])}<p class="seo-team-note">This is Cartethyia's best specialist composition. Ciaccona applies Aero Erosion while Chisa adds the specialist stack, damage, healing, and shielding tools. Kumokiri raises Chisa's team-damage ceiling further.</p></div><div class="seo-team-panel"><header><strong>Accessible alternative</strong><span>Free healer route</span></header>${teamStrip([["cartethyia", "Main DPS", "Cartethyia"], ["ciaccona", "Sub DPS", "Ciaccona"], ["rover", "Support", "Aero Rover"]])}<p class="seo-team-note">Aero Rover is the free, reliable healing alternative to Chisa. Both third-slot options help Cartethyia reach the higher Erosion stack limit; choose Rover when comfort, access, or multi-wave reliability matters.</p></div><div class="seo-team-panel"><header><strong>Comfort route</strong><span>Safer alternative</span></header>${teamStrip([["cartethyia", "Main DPS", "Cartethyia"], ["ciaccona", "Sub DPS", "Ciaccona"], ["shorekeeper", "Support", "Shorekeeper"]])}<p class="seo-team-note">Keep Ciaccona's Erosion core, then use Shorekeeper when healing, Crit support, and a calmer multi-wave rotation matter more than maximum specialist output.</p></div></div>`,
  ...
  ciaccona: {
    ...
    panels: `<div class="seo-team-panels"><div class="seo-team-panel"><header><strong>Best Cartethyia team</strong><span>Recommended</span></header>${teamStrip([["cartethyia", "Main DPS", "Cartethyia"], ["ciaccona", "Sub DPS", "Ciaccona"], ["chisa", "Support", "Chisa"]])}<p class="seo-team-note">Ciaccona is Cartethyia's core Erosion partner, while Chisa is the best specialist third slot for the highest-output version of the team.</p></div><div class="seo-team-panel"><header><strong>Accessible Cartethyia team</strong><span>Free healer route</span></header>${teamStrip([["cartethyia", "Main DPS", "Cartethyia"], ["ciaccona", "Sub DPS", "Ciaccona"], ["rover", "Support", "Aero Rover"]])}<p class="seo-team-note">Aero Rover fills the same stack-support job with reliable healing and a free dedicated weapon, making this the most accessible alternative to Chisa.</p></div><div class="seo-team-panel"><header><strong>Comfort route</strong><span>Alternative</span></header>${teamStrip([["cartethyia", "Main DPS", "Cartethyia"], ["ciaccona", "Sub DPS", "Ciaccona"], ["shorekeeper", "Support", "Shorekeeper"]])}<p class="seo-team-note">Use Shorekeeper when healing, Crit support, and a calmer multi-wave rotation matter more than specialist output.</p></div></div>`,
