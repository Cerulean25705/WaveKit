...
const specificGuides = {
  ...
  ciaccona: {
    shells: [["cartethyia", "ciaccona", "rover"], ["cartethyia", "ciaccona", "chisa"], ["cartethyia", "ciaccona", "shorekeeper"]],
    panels: `<div class="seo-team-panels"><div class="seo-team-panel"><header><strong>Cartethyia R0-R1 team</strong><span>Recommended</span></header><p>Cartethyia / Ciaccona / Aero Rover</p><p class="seo-team-note">Aero Rover supplies the stack support low-sequence Cartethyia needs to reach her full Aero Erosion plan.</p></div><div class="seo-team-panel"><header><strong>Cartethyia R2+ route</strong><span>Specialist</span></header><p>Cartethyia / Ciaccona / Chisa</p><p class="seo-team-note">From Cartethyia R2, Chisa can replace Aero Rover as the specialist third slot.</p></div><div class="seo-team-panel"><header><strong>Comfort route</strong><span>Alternative</span></header><p>Cartethyia / Ciaccona / Shorekeeper</p><p class="seo-team-note">Use Shorekeeper when reliable healing and a lower-stress rotation matter more than the specialist third slot.</p></div></div>`,
    ...
    teammates: `Prioritise Cartethyia for the clearest Erosion pairing. At Cartethyia R0-R1, Aero Rover is the preferred third slot; from R2, Chisa can replace Rover. Shorekeeper or Verina can make the team safer.`,
    faq: `Ciaccona's clearest team direction is Cartethyia / Ciaccona / Aero Rover at Cartethyia R0-R1. From R2, Chisa can replace Aero Rover, while a dedicated healer remains the comfort option.`
  }
};
