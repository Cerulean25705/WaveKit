...
const priorities = {
  ...
  buling: ["Energy Regen until the requirement is met: roughly 160-180% before S2, or 125-135% at S2+", "CRIT Rate and CRIT DMG", "ATK%", "Flat ATK"],
  ...
  hiyuki: ["Energy Regen to roughly 120% for a complete rotation", "CRIT Rate and CRIT DMG; stop adding CRIT Rate once the build is comfortable", "ATK%", "Resonance Liberation DMG Bonus"],
  ...
  lucilla: ["CRIT Rate and CRIT DMG", "ATK%", "Flat ATK", "Basic Attack DMG Bonus in Glacio Chafe mode; skip it in Echo Skill mode"],
  ...
  "yangyang-xuanling": ["Energy Regen until the rotation is smooth, usually 107-119%", "CRIT Rate and CRIT DMG", "ATK%", "Heavy Attack DMG Bonus"],
