const CACHE_NAME = "wavekit-shell-v54";
const APP_SHELL = [
  "/",
  "/index.html",
  "/site.webmanifest",
  "/weapons/",
  "/styles.css?v=release-20260719-beta-2",
  "/characters/",
  "/assets/characters-page.js?v=characters-directory-1",
  "/app.js?v=release-20260719-2",
  "/assets/mobile-navigation.js?v=release-20260718-2",
  ...
  "/assets/weapons-page.js?v=release-20260718-2",
